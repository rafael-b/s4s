...
#============================================================================================================================
  ...
  def self.sort_by_link(name,field_name,filter=nil,sorter=true,options={})
    ...
    if sorter
      ...
      s += RFilterHelper.js_link("document.getElementById('filter_sort_by').value='#{field_name}';document.getElementById('filter_sort_by_order_flip').value='yes';document.getElementById('filters').submit();",:label=>name,:title=>options[:title])
